...
class DoneView extends StatefulWidget {
  ...
  @override
  State<DoneView> createState() => _View2State();
}

class _View2State extends State<DoneView> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget body() {
    return Padding(
      ...
      child: ListView.separated(
          ...
          itemCount: Cubita.get(context).listOfDBDone == null
              ? 0
              : Cubita.get(context).listOfDBDone!.length),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  children: [
                    Text(
                      '${Cubita.get(context).listOfDBDone![index]['title']}',
                    ...
                    Text(
                      '  '
                      '${Cubita.get(context).listOfDBDone![index]['content']}',
                      style:
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        Cubita.get(context).updateTask(
                            status: 'done',
                            id: Cubita.get(context).listOfDBDone![index]['id']);
                      },
                      icon: const Icon(
                        Icons.check_box,
                        size: 28,
            ...
            Text(
              '${Cubita.get(context).listOfDBDone![index]['date']}',
